                                ...
                                <div class="col-sm-10">
                                    <select name="section_id[]" id="section_id" class="form-control select2-multiple"
                                        ...
                                        @foreach ($fatherSections as $fatherSection)
                                            ...
                                            @foreach ($subFatherSection->fatherSections as $subSubFatherSection)
                                                <?php
                                                if ($subSubFatherSection->$title_var != "") {
                                                    $title = $subSubFatherSection->$title_var;
                                                } else {
                                                    $title = $subSubFatherSection->$title_var2;
                                                }
                                                ?>
                                                <option value="{{ $subSubFatherSection->id  }}" {{ (in_array($subSubFatherSection->id,$categories)) ? "selected='selected'":""  }}> {{ $ftitle }} {{$t_arrow}} {{ $subFatherSection->$title_var }} {{$t_arrow}} {{ $title }}</option>
                                            @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("ar_box_status"))
                                        ...
                                        $seo_example_url = route('FrontendProduct', ["id" => $Topics->id]);
                                        }
                                        elseif($WebmasterSection->name == 'blog')
                                        {
                                            
                                            $seo_example_url = route('FrontendTopicsByCat', ["id" => $Topics->id]);
                                        }
    ...
    <script>
        ...
        $("#seo_url_slug_ar").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#url_in_engines_ar").text("<?php 
                      if($Topics->webmasterSection->name == 'products') {
                                    echo route('FrontendProduct', ["id" => $Topics->id]);
                                        }
                                        elseif($Topics->webmasterSection->name == 'blog')
                                        {
                                            
                                            echo route('FrontendTopicsByCat', ["id" => $Topics->id]);
                                        }
