                    ...
                    <div class="tab-pane {{  ( Session::get('active_tab') == 'styleTab') ? 'active' : '' }}" id="tab-5">
                        ...
                        <div class="p-a-md col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <label>{{ trans('backLang.footerlogoStyle') }} : </label>
                                <div class="row">
                                    <div class="col-sm-6">
                                            ...
                                            <div>
                                                <div>
                                                    <div id="footer_bg" class="col-sm-8 box p-a-xs">
                                                        <a target="_blank"
                                                           href="{{ URL::to('uploads/settings/'.$Setting->footer_logo) }}"><img
                                                                    src="{{ URL::to('uploads/settings/'.$Setting->footer_logo) }}"
                                                                    class="img-responsive">
                                                            {{ $Setting->footer_logo }}
                                                        </a>
                                                        <br>
                                        ...
                                        @endif
                                        {!! Form::file('footer_logo', array('class' => 'form-control','id'=>'footer_logo','accept'=>'image/*')) !!}
                                        <small>
                                            <i class="material-icons">&#xe8fd;</i>( 260x60 px ) -
                                            {!!  trans('backLang.imagesTypes') !!}
                                        </small>
