    ...
    public function updateSiteInfo(Request $request)
    {
        ...
        if (!empty($Setting)) {
            ...
            $this->validate($request, [
                ...
                'footer_logo' => 'mimes:png,jpeg,jpg,gif|max:3000'
            ]);
            ...
            $formFileName5 = "footer_logo";
            $fileFinalName5 = "";
            if ($request->$formFileName5 != "") {
                // Delete a footer_logo photo
                if ($Setting->footer_logo != "") {
                    File::delete($this->getUploadPath() . $Setting->footer_logo);
                }
            ...
            if ($fileFinalName5 != "") {
                $Setting->footer_logo = $fileFinalName5;
            }
