...
Route::post('/comment', 'http://localhost:8000@commentSubmit')->name('commentSubmit');
...
//router custom quote page



Route::get('/request/quote', 'FrontendHomeController@Requestquote')->name('Requestquote');
...
Route::post('/search/blogs', 'FrontendBlogController@searchBlogs')->name('searchBlogs');

//single blog
Route::get('/blog/detail/{id}', 'FrontendBlogController@show')->name('FrontendBlogDetail');

// ..Sub category url for Section  ( ex: www.site.com/products/2 )
Route::get('/blogs/{cat}', 'FrontendHomeController@topics')->name('FrontendTopicsByCat');

//blogs
Route::get('/blogs', 'FrontendBlogController@index')->name('FrontendBlogsPage');


//frontend product page (raza)
Route::get('/products/{cat}', 'FrontendProductController@index')->name('FrontendProductsByCat');
Route::get('/product/{id}', 'FrontendProductController@show')->name('FrontendProduct');
Route::get('/products', 'FrontendProductController@index')->name('FrontendProducts');
...
//Route::get('/thank-you', 'CheckoutController@thankyou')->name('thankyou');

//frontend customer login

Route::post('/user/login', 'UserController@loginthroughcheckout')->name('userLogin');
Route::get('/account/login', 'FrontendHomeController@showSignInFront')->name('accountLogin');
...
Route::get('/order/fail', 'OrderController@orderFail');
